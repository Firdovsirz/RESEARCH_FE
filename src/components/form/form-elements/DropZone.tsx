...
const DropzoneComponent: React.FC<DropzoneComponentProps> = ({ onFileSelect }) => {
  ...
  return (
    <div className="w-full transition border border-gray-300 border-dashed cursor-pointer dark:hover:border-brand-500 dark:border-gray-700 rounded-xl hover:border-brand-500">
      <form
        {...getRootProps()}
        className={`w-full dropzone rounded-xl   border-dashed border-gray-300 p-7 lg:p-10
        ${isDragActive
