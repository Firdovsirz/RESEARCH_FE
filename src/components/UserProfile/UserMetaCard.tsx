        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              Şəxsi məlumatlarda düzəliş edin
            </h4>
          </div>
          <form className="flex flex-col">
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              <button
                type="button"
                className="px-4 py-2 text-sm border rounded-md text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800"
                onClick={(e: React.MouseEvent<HTMLButtonElement>) => {
                  ...
                  setTimeout(() => {
                    Swal.fire({
                      title: "Əminsiniz?",
                      text: "Dəyişikliklər yadda saxlanılmayacaq!",
                      icon: "warning",
